function input_data() {
    ...
    parameter_float("Total length", "L", "", <total_length>, UNIT.LENGTH, .1, .1, 50, true, true);
        editable_condition("input_via == define_L1 || input_via == define_L2");

        parameter_float("Length of outer bays", "L_1", "L<sub>1</sub>", 6, UNIT.LENGTH, .1, .1, 50, true, true);
        editable_condition("input_via == define_L1 || input_via == define_L1_L2");

        parameter_float("Length of inner bays", "L_2", "L<sub>2</sub>", 7, UNIT.LENGTH, .1, .1, 50, true, true);
